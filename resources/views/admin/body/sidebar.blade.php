<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item nav-category">Digital Library</li>
            <li class="nav-item">
                ...
                <div class="collapse" id="emails">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('all.collections') }}" class="nav-link">All Collections</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('all.catalogs') }}" class="nav-link">All Catalogs</a>
                        </li>
                        {{-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="{{ route('all.hakakses') }}" class="nav-link">
