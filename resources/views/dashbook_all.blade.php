...
<head>
    ...
    <title>Paperless FKKUMJ</title>
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/icon" href="{{ asset('frontend/images/favicon.ico') }}" />
    <!-- Font Awesome -->
                    ...
                    <div class="col-md-12">
                        <div class="mu-book-overview-area">
                            ...
                            <div class="mu-heading-area">
                                ...
                                <p>Kumpulan koleksi buku, jurnal, skripsi, tesis, novel dan lain-lain pada perpustakaan
                                    Fakultas Kedokteran dan Kesehatan Universitas Muhammadiyah Jakarta</p>
                            </div>
                            ...
                            <div class="mu-book-overview-content">
                                <div class="row">
                                    ...
                                    {{-- Bacaan pada perpustakaan FKK UMJ yang dapat diakses oleh public/umum --}}
                                    ...
                                    @foreach ($catalogs as $catalog)
                                        <div class="col-md-3 col-sm-6">
                                            <div class="mu-book-overview-single">
                                                ...
                                                <h4><a
                                                        href="{{ route('read.book', $catalog->id) }}">{{ $catalog->judul }}</a>
                                                </h4>
                                                <p>{{ $catalog->penulis . ' (' . substr($catalog->tahun, 0, 4) . ')' . ' - ' . $catalog->penerbit }}
                                                </p>
                                                <figcaption class="blockquote-footer text-danger">Read :
                                                    <a href="{{ route('read.pdf', $catalog->id) }}">
                                                        <span class="badge bg-primary">Pdf</span>
                                                    </a>
                                                    <a href="{{ route('read.book', $catalog->id) }}">
                                                        <span class="badge bg-warning">Flipbook</span>
                                                    </a>
                                                </figcaption>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mu-author-image">
                                            <img src="{{ asset('frontend/images/author.jpg') }}" alt="Author Image">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
